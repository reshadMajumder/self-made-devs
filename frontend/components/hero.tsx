        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Link href="/register">
              <Button
                size="lg"
                className="text-lg font-semibold text-white px-8 py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/70 transition-all duration-300 hover:scale-105"
              >
                Join the Journey
                <ArrowRightFromLine />
              </Button>
          ...
          <div className="grid grid-cols-3 gap-8 pt-12 max-w-2xl mx-auto">
            ...
            <div className="space-y-2">
              <div className="text-4xl font-bold text-pink-400 drop-shadow-lg">
                ∞
              </div>
